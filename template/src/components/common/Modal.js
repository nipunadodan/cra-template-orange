    ...
    return (
        <>
            <Transition appear show={isOpenModal} as={Fragment}>
                <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto backdrop-blur-sm bg-black/5 dark:bg-white/5" onClose={closeModal}>
                        ...
                        <Transition.Child
                            ...
                            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-gray-700 shadow-xl rounded-2xl">
                                <div className={'flex justify-between align-middle'}>
                                    <Dialog.Title
                                        as="h3"
                                        className="text-2xl font-medium leading-6 text-gray-900 dark:text-gray-100 mt-1">
                                        {modal.title}
                                    </Dialog.Title>
